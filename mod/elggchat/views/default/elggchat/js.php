<?php
	...
	*/
	...
	/*<a href='javascript:inviteFriends(" + i + ")'><?php echo strtolower(elgg_echo("elggchat:chat:invite")); ?></a>*/
...
?>
		...
		$.getJSON("<?php echo $CONFIG->wwwroot; ?>action/elggchat/poll", function(data){
				...
				$.each(data.sessions, function(i, session){
					...
					if( (i != current || sessionExists == false) ){
						...
						newSession += "<div class='chatsessiondata'>"; 
							...
							newSession += "<div class='chatmembersfunctions' style='background-color:white;'>";
			...
			// build friendspicker
                        try {
                            ...
                            $("#elggchat_friends a").html("<?php echo elgg_echo("elggchat:friendspicker:info");?> (0)");
                        }
    ...
    /*$j(document).click(function(){
        if( $j('#latest_river').is(':visible') ) {
           	$j('#latest_river').hide('slow');
        }
    });*/