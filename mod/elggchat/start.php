<?php
	...
	*/
	...
	define("CHAT_ENABLE" , "chat_enable" );
	define("CHAT_DISABLE", "chat_disable");
	...
	function elggchat_init() {
		if(isloggedin()){
			if(get_plugin_usersetting("enableChat") != "no"){
				...
				extend_view('elggchat/item', 'item/extra');
				
				// elggchat_extensions
				extend_view('elggchat/extensions', 'elggchat_extensions/latest_river');
				extend_view('elggchat/extensions', 'elggchat_extensions/toolbar');
