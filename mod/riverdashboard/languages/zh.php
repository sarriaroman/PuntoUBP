<?php
	...
	$chinese = array(
		...
		'riverpost' => '帖子',
		'river:post:charleft' => '个字符剩余',
		'river:post:posted' => '帖子已发表',
		'river:post:failure' => '帖子发表失败，很可能是网站遇到了技术问题，请和管理员联系',
		'river:comment' => '我来说两句',
		'river:item:toggle_comments' => "显示/隐藏回复",
		'river:comment:post' => '发表',
		'sidebox:recent_members' => '新成员',
		'sidebox:birthday_members' => '过生日的成员',
		'today' => '今天',
		'tomorrow' => '明天',
		'aftertomorrow' => '后天',
		'riverdashboard:welcome' => '%s，欢迎来到朋友帮',
	
		'river:image:goto_full' => '查看全尺寸图片',
		'river:image:toggle_size' => '放大/缩小',
		/*
		 * MOD END by Snow
		 */ 
		...
		'river:widget:noactivity' => '此人很安静，提醒ta活动一下吧',
