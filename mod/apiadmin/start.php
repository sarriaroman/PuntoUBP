<?php
	...
	function apiadmin_init($event, $object_type, $object = null) {
		...
		register_action("apiadmin/revokekey",false, $CONFIG->wwwroot. "/mod/apiadmin/actions/revokekey.php", true);
		register_action("apiadmin/generate",false, $CONFIG->wwwroot . "/mod/apiadmin/actions/generate.php", true);
	}
