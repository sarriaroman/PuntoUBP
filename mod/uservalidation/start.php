<?php
	...
	function uservalidation_bymail_validation($object)
	{
		...
		$result = notify_user($object->guid, $CONFIG->site->guid, sprintf(elgg_echo('uservalidation:admin:validate:subject'), $object->username), sprintf(elgg_echo('uservalidation:admin:validate:body'), $object->name, $link), NULL, 'email');
		if ($result)
