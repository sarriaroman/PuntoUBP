<?php
	...
	$info .= "<a href=\"#\" onclick=\"$('#registerinfo_showhide{$applicant->guid}').toggle();return false;\">".elgg_echo('toggle_details')."</a>";
	$info .= "</p>\n";
	$info .= "<div id=\"registerinfo_showhide{$applicant->guid}\" style=\"display:none\">".elgg_view('profile/details',array('entity' => $applicant))."</div>\n";
