    ...
    <div class="messages_single"><!-- start of the message div -->
		...
		<div id="message_reply_form">
			<form action="<?php echo $vars['url']; ?>action/messages/send" method="post" name="messageForm">
				...
				<p><label><?php echo elgg_echo("messages:title"); ?>: <br /><input type='text' name='title' class="input-text" value="RE: <?php echo htmlentities($vars['entity']->title,ENT_QUOTES,"UTF-8"); ?>" /></label></p>
