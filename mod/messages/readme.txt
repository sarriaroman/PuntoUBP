/**
	 ...
	 * @link http://elgg.com/
	 * modified by id.facyla.net to support group mailing
	 * version : 2009.04.28
*/

Install: replace former "messages" mod by this plugin (unactivate "messages", rename it, drop new "messages" plugin into /mod/, activate it, and run upgrade.php script).

Enhancements : added group et contacts groups messaging.
