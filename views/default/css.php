...
#elgg_topbar_container_right a.pagelinks {
	color: white;
	margin:0 0px 0 5px;
	display:block;
	padding:3px;
...
#elgg_topbar_container_right a.pagelinks:hover {
	/* background: #faa198; */
	text-decoration: none;
	background-color: #bd0000;
	/*-moz-border-radius-topleft:5px;
...
.submit_button {
	...
	border-top: 1px solid #D6644E;
	border-right: 1px solid #D6644E;
	border-bottom: 1px solid #471006;
	border-left: 1px solid #471006;
	width: auto;
	height: 25px;
